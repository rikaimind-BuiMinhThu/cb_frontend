...
const HtmlCodeMessagePreview = ({
  ...
  const borderStyle = themeSettings?.botMessageBorderStyle || 'with_tail';
  const showBotMessageTail = borderStyle !== 'no_tail';
    ...
    <div className="ss-bot-chat-text-input-shell position-relative">
      ...
      {showBotMessageTail && (
        <div
          ...
          style={iconMess ? { '--bot-icon-mess': `url(${iconMess})`, background: `url(${iconMess})` } : undefined}
        >
          {!iconMess && (
