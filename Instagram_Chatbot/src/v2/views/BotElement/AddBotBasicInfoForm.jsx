...
import DesignBotIcons from './BotSetting/DesignSetting/DesignSettingComponents/DesignBotIcons';
...
import BasicInfoStatePreview from './BotSetting/DesignSetting/components/BasicInfoStatePreview';
import DesignSettingLabel from './BotSetting/DesignSetting/components/shared/DesignSettingLabel';
import { getDesignSettingTooltip } from './BotSetting/DesignSetting/constants/designSettingTooltips';

/**
 * Form create-bot, layout copy từ tab 基本情報 (BasicInfoTab).
 * File này nằm ngoài DesignSetting để không sửa design-setting.
 * Khác BasicInfoTab: nút 閉じる + ボット新規作成 thay cho 保存.
 */
const errorStyle = (message) => ({
  display: message ? 'block' : 'none',
});

const AddBotBasicInfoForm = ({
  basicInfo,
  validationErrors,
  iconPresetIndices,
  onFieldChange,
      ...
      <div className="add-bot-container">
        <div className="bot-left">
          ...
          <div className="btn-wrapper admin-form-actions">
            <AdminActionButton action="cancel" label="閉じる" onClick={onClose} />
            <AdminActionButton action="create" label="ボット新規作成" onClick={onCreate} />
          </div>
        </div>
...
AddBotBasicInfoForm.defaultProps = {
  iconPresetIndices: {
    bot: null,
    opening: null,
    closing: null,
...
export default AddBotBasicInfoForm;
