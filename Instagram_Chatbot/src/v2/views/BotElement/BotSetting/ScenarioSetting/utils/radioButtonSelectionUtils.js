export function getRadioOptionSelectionKey(item) {
...
export function isRadioOptionInitiallySelected(radioButton, item) {
...
export function isEditorRadioOptionHighlighted(
...
export function buildEditorRadioOptionDataAttr(indexContent, item) {
  return `${indexContent}-${item?.id ?? ''}`;
}
