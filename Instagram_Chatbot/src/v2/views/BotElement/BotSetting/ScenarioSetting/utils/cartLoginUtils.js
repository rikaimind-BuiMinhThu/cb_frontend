...
export function normalizeCartLoginConfig(config) {
...
export function buildCartLoginStyle(config) {
...
function buildFindElementHelperJs() {
  return `
...
function buildSelectorFindJs(variableName, selector) {
...
export function buildCartLoginClickJs(config) {
  const normalized = normalizeCartLoginConfig(config);
...
export function getCartLoginHoverBackgroundColor(config) {
  return normalizeCartLoginConfig(config).style.hover_background_color
    || DEFAULT_CART_LOGIN_CONFIG.style.hover_background_color;
}

export function shouldCloseBotAfterCartLoginClick(config) {
...
export function getCartLoginCloseDelayMs(config) {
  const normalized = normalizeCartLoginConfig(config);
