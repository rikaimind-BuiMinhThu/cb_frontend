      ...
      <div className="content">
        <Row>
          <Col lg="3" md="6" sm="6" id='client_management'>
            <a href="/v2/admin/client-management">
          ...
          <Col lg="3" md="6" sm="6" id='user_management'>
            <a href="/v2/admin/user-management">
              <Card className="card-stats">
                <CardBody>
                  <Row>
                    <Col md="3" xs="5">
          ...
          <Col lg="3" md="6" sm="6">
          {client?.is_instagram ? (<a href="/v2/admin/keyword">
              <Card className="card-stats">
                <CardBody>
                  <Row>
                    <Col md="4" xs="5">
          ...
          <Col lg="3" md="6" sm="6">
          {client?.is_instagram ? (<a href="/v2/admin/chatbot">
              <Card className="card-stats">
                <CardBody>
                  <Row>
                    <Col md="4" xs="5">
