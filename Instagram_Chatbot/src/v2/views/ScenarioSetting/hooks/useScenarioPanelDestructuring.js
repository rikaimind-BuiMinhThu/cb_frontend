...
export const useScenarioPanelDestructuring = () => {
  ...
  const {
    ...
    timerConfig, errMsgJsCode, errMsgSettingMode, errMsgFieldSelectors, errMsgFormSelectors,
    launchButtonSelectors, isOpenErrMsgByJsSettingModal, isUseErrMsgByJs,
    errorScenarioName, belongTo, messageType, indexMessageSelect, dataInputVar,
    varFileReference, isOpenFileReference, indexCarouselSlide,
  ...
  const {
    ...
    setTimerConfig, setErrMsgJsCode, setErrMsgSettingMode, setErrMsgFieldSelectors,
    setErrMsgFormSelectors, setLaunchButtonSelectors, setIsOpenErrMsgByJsSettingModal, setIsUseErrMsgByJs,
    setErrorScenarioName, setBelongTo, setMessageType, setIndexMessageSelect,
    setDataInputVar, setVarFileReference, setIsOpenFileReference,
  ...
  const {
    ...
    handleAddItemSetting, handleAddCombineBlock, handleChangeCombineBlockType,
    handleChangeCombineContentGap, handleChangeCombineBlockPadding,
    handleCopyMessage, handleDeleteMessageContent, handleDeleteMessage,
