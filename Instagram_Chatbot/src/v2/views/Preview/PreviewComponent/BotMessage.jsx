...
import { buildOrderConfirmJs, buildOrderConfirmPreviewHtml } from "v2/views/ScenarioSetting/utils/OrderConfirmLpScriptGenerator";
...
const BotMessage = ({
  ...
  const { bgColor: botMessageBgColor, showTail: showBotMessageTail } = resolveBotMessageTheme(themeSettings, botInfor);
            ...
            {!botInfor?.icon_mess && (
              <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="12" height="18" viewBox="0 0 37 54">
                <path
                  ...
                  fill={botMessageBgColor} transform="translate(14,0)" />
              </svg>
            )}
          </div>
        )}
