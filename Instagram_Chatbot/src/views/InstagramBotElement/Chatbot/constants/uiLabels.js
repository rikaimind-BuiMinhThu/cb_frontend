...
export const TOAST_MESSAGES = {
  ...
  GROUP_DELETE_IN_USE: 'グループは利用中のため、削除できません！',
  GROUP_DELETE_FAILED: 'メッセージグループの削除に失敗しました。',
  ...
  BAG_DELETE_IN_USE: 'メッセージ袋は利用中のため、削除できません！',
  BAG_DELETE_FAILED: 'メッセージ袋の削除に失敗しました。',
