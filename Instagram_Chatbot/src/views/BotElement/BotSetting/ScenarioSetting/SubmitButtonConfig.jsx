    ...
    <div className="submit-button-config_holder">
      <div className="style-submit-button_holder">
        ...
        <textarea 
          ...
          onChange={(event) => onChange(messageIndexSelect, contentIndex, content.type, event?.target?.value, "style")}
      ...
      <div className="loading-submit-button_holder">
        <CheckboxCustom
          ...
          onChange={value => onChange(messageIndexSelect, contentIndex, 'button_submit_use_loading_text', value)}
        ...
        {!!content.button_submit_use_loading_text && (
          <SubmitButtonLoadingConfig
            onChange={onChange} 
            content={content} 
            messageIndexSelect={messageIndexSelect}
