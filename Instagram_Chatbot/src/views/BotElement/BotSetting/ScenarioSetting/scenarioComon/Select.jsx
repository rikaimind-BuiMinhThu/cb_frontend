...
const Select = ({ id, data, value, onChange, keyValue = "key", style, placeholder }) => {
  ...
  console.log(value, 'cgheckkkk value');
  ...
  return (
    <React.Fragment>
          <div
            ...
            id={`ss-select-custom-${id}`} className="ss-select-custom" style={style}>
            <input
