            ...
            messages: [
                {
                    ...
                    message_content: [
                        {
                            type: 'text',
                            // bot has 6 value: text, file, email, script, deplay, api_link_age(pending)
                            // user has 10 value: text_input, label, textarea, radio_button, checkbox, 
                            // pull_down, zipcode_address, attching_file, calender, agree_to_term
                            message_detail:
                            {
                                user_title: '',//string
