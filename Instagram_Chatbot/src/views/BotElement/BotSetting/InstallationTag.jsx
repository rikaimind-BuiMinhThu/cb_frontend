...
function InstallationTag() {
  ...
  const faqScript = buildFaqEmbedScript(botId, faqSdkUrl);

  useEffect(() => {
    setUrlDemo('/admin/demo-bot/' + botId);
            ...
            <Card>
              ...
              <CardBody>
                <div style={{ marginBottom: '30px' }}>
                  ...
                  <span style={{ color: '#767676', fontWeight: '400' }}>
                    ページの右下にウェブチャットを表示するためにウェブサイトの &lt;body&gt; タグ内に以下のコードを貼り付けてください。
                  </span>
                  <textarea
                    disabled
                    readOnly
