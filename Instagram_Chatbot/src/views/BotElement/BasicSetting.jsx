                ...
                <form id='form-basic-setting'>
                  ...
                  <div className='field-container'>
                    ...
                    <div className='field-input'>
                      ...
                      <span id="errDepartment" className='err-format'></span>
                    </div>
                  </div>
                  ...
                  <div className='field-container'>
                    ...
                    <div className='field-input'>
                      ...
                      <span id="errPosition" className='err-format'></span>
                    </div>
                  </div>
                  ...
                  <div className='field-container'>
                    ...
                    <div className='field-input'>
                      ...
                      <span id="errPhone" className='err-format'></span>
                    </div>
                  </div>
                  ...
                  <div className='field-container'>
                    ...
                    <div className='field-input'>
                      ...
                      <span id="errPostCost" className='err-format'></span>
                    </div>
                  </div>
                  ...
                  <div className='field-container'>
                    ...
                    <div className='field-input'>
                      ...
                      <span id="errAddress" className='err-format'></span>
                    </div>
                  </div>
